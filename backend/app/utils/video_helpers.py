...
def load_prompt_markdown(filename: str) -> str:
    ...
    prompt_cache[filename] = (mtime_ns, text)
    return text


def get_ask_video_system_prompt() -> str:
    return load_prompt_markdown("ask_video_system.md")


def get_video_analysis_prompt() -> str:
    return load_prompt_markdown("video_analysis.md")


def get_transcript_prompt() -> str:
    return load_prompt_markdown("transcript.md")


def get_detect_prompt() -> str:
    return load_prompt_markdown("detect.md")


# Currently unused: the video analysis endpoint relies on prompt instructions plus
# response parsing/normalization instead of passing a Bedrock response schema.
#
